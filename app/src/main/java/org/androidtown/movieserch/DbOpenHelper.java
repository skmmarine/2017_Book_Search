...
public class DbOpenHelper {
    ...
    // Insert DB
    public long insertColumn(String name, String genre, String story){
        ContentValues values = new ContentValues();
        values.put(DataBases.CreateDB.NAME, name);
        values.put(DataBases.CreateDB.GENRE, genre);
        values.put(DataBases.CreateDB.STORY, story);
        return mDB.insert(DataBases.CreateDB._TABLENAME, null, values);
    }

    // Update DB
    public boolean updateColumn(long id , String name, String genre, String story){
        ContentValues values = new ContentValues();
        values.put(DataBases.CreateDB.NAME, name);
        values.put(DataBases.CreateDB.GENRE, genre);
        values.put(DataBases.CreateDB.STORY, story);
